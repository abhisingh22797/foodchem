                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="description">sec1 Description</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sec1_title">sec2 Title</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="description">sec2 Description</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sec1_title">sec3 Title</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="description">sec3 Description</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sec1_title">sec4 Title</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="description">sec4 Description</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sec1_title">sec5 Title</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="description">sec5 Description</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sec1_title">sec6 Title</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="description">sec6 Description</label>
