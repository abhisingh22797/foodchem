...
class Course extends BaseController
{
    ...
    function courseListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Fiesttech : Courses Listing';
    ...
    function addNew()
    {
        ...
        {   $data['c_cat'] = $this->course_model->getCourseCat();
            ...
            $this->global['pageTitle'] = 'Fiesttech : Add New Course';
   ...
   public function uploadfilesamenames($file,$tem)
  {
    ...
    function editOld($cId = NULL)
    {
           ...
           // $this->uri->segment();
            ...
            $this->global['pageTitle'] = 'Fiesttech : Edit Course';
    ...
    {
        $this->global['pageTitle'] = 'Fiesttech : 404 - Page Not Found';
