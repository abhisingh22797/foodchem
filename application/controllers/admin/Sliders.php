...
class Sliders extends BaseController
{
    ...
    function index()
    {
        ...
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'M R Scientific  : slider Listing';
    ...
    function sliderListing()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'M R Scientific : Gallery Listing';
    ...
    function viewsliders()
    {
        ...
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'M R Scientific :slider';
    ...
    function addSlider()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'M R Scientific  : Add New slider';
