...
class Products extends BaseController
{
  ...
  public function viewproducts()
  {
    ...
    if ($this->isAdmin() == TRUE) {
      ...
      $this->global['pageTitle'] = 'M R Scientific  :products';
  ...
  public function addproducts()
  {
    if ($this->isAdmin() == TRUE) {
      ...
      if ($this->input->post('submit') !== NULL) {
        ...
        // print_r($forminput);
        $last_id =  $this->products_model->insertproducts($forminput);
  ...
  function editproducts()
  {
    ...
    if ($this->input->post('submit') !== NULL) {
      ...
      $formArray["eno"] = $this->input->post('eno');
      $formArray["casno"] = $this->input->post('casno');
      $formArray["qty"] = $this->input->post('qty');
      $formArray["minorder"] = $this->input->post('minorder');
      $formArray["packaging"] = $this->input->post('packaging');
